...
- Requires the ordered transition watch reel to be explicitly muted in safe workflow, final QA, repair commands, and the downstream review audit, so transition review cannot leak source-camera/user audio or falsely claim BGM-only readiness.
