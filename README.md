...
- Audits one-shot autonomy so a raw unordered folder must prove intake, source selection, story, rhythm, BGM, captions, titles, transitions, repair closure, whole-film satisfaction, unattended first draft, and preflight are connected before claiming another AI can produce a V14-level first run without extra diagnosis.
...
- one-shot autonomy contract aggregating raw-folder intake, source selection, story, rhythm, BGM, captions, titles, transitions, repair closure, whole-film satisfaction, unattended first-draft closure, and Resolve preflight into a no-extra-diagnosis first-run gate
