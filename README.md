...
curl -L -o /tmp/travel-video-studio-skill-v0.1.100.tar.gz \
  https://github.com/junwen853/travel-video-studio-skill/releases/download/v0.1.100/travel-video-studio-skill-v0.1.100.tar.gz
tar -xzf /tmp/travel-video-studio-skill-v0.1.100.tar.gz --strip-components=1 -C ~/.codex/skills/travel-video-studio
```
