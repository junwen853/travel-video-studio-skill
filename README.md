...
- Audits one-shot autonomy so a raw unordered folder must prove intake, source selection, story, rhythm, BGM, captions, titles, ordered muted transition watch reel/review, current-output editorial watchdown, repair closure, whole-film satisfaction, unattended first draft, and preflight are connected before claiming another AI can produce a V14-level first run without extra diagnosis.
...
curl -L -o /tmp/travel-video-studio-skill-v0.1.102.tar.gz \
  https://github.com/junwen853/travel-video-studio-skill/releases/download/v0.1.102/travel-video-studio-skill-v0.1.102.tar.gz
tar -xzf /tmp/travel-video-studio-skill-v0.1.102.tar.gz --strip-components=1 -C ~/.codex/skills/travel-video-studio
```
...
- one-shot autonomy contract aggregating raw-folder intake, source selection, story, rhythm, BGM, captions, titles, ordered muted transition watch reel/review, current-output editorial watchdown, transition satisfaction, repair closure, whole-film satisfaction, unattended first-draft closure, and Resolve preflight into a no-extra-diagnosis first-run gate
