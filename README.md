...
- Converts transition decisions into Resolve-ready recipes, audits the whole transition motif chain, plans 2-5 shot bridge sequences, and materializes those beats into a non-destructive Resolve candidate blueprint.
