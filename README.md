...
curl -L -o /tmp/travel-video-studio-skill-v0.1.105.tar.gz \
  https://github.com/junwen853/travel-video-studio-skill/releases/download/v0.1.105/travel-video-studio-skill-v0.1.105.tar.gz
tar -xzf /tmp/travel-video-studio-skill-v0.1.105.tar.gz --strip-components=1 -C ~/.codex/skills/travel-video-studio
```
...
- one-shot autonomy contract aggregating raw-folder intake, source selection, story, rhythm, BGM, captions, titles, ordered muted transition watch reel/review, reference-profile application, reference transition profile, reference scene grammar, timeline variety, director intent, route texture, current-output editorial watchdown, transition satisfaction, repair closure, whole-film satisfaction, unattended first-draft closure, and Resolve preflight into a no-extra-diagnosis first-run gate
