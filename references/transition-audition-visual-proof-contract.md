...
Use this contract immediately after `audit_transition_audition_quality_contract.py` and before storyboard approval, Resolve apply, final QA, maturity, unattended first-draft, or V14 baseline claims.
...
If this blocks, do not approve the storyboard or Resolve apply. Repair the transition execution blueprint, preview packet, bridge visual evidence, or audition packet, then rebuild the audition MP4s and rerun both audition quality and visual-proof audits.
