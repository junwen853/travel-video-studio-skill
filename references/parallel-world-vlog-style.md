...
- The chapter arc plan exists at `chapter_arc_plan/chapter_arc_plan.json`, `chapter_story_spine_contract_audit.json`, `shot_flow_continuity_contract_audit.json`, and `transition_breathing_room_contract_audit.json` pass, and missing or badly ordered beats are repaired before effects are chosen.
