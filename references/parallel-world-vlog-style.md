...
- The transition polish blueprint report plus application audit proves final transitions have BGM-hit timing, title/subtitle avoidance, motion-proof, restrained keyframes, and active/final-blueprint survival before Resolve apply.
