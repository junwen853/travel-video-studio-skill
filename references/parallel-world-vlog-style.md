...
- `reference_transition_profile_contract_audit.json` passes, proving the current film's transition language matches the learned bridge, breath, visual-match, and restrained-motion balance instead of only storing reference analysis.
