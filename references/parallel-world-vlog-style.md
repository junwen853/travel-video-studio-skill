...
- The transition reference-readiness contract, final viewer friction contract, first draft satisfaction contract, and unattended repair queue exist before unattended/V14/final QA; a blocked draft may keep actionable rows, but a reference-ready draft should have no remaining P0/P1 transition, viewer-facing, or first-draft satisfaction rows.
