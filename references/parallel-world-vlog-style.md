...
- The transition reference-readiness contract, transition sequence satisfaction contract, final viewer friction contract, first draft satisfaction contract, whole film satisfaction contract, and unattended repair queue exist before unattended/V14/final QA; a blocked draft may keep actionable rows, but a reference-ready draft should have no remaining P0/P1 transition, viewer-facing, first-draft, or whole-film satisfaction rows.
