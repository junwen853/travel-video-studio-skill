...
Run `scripts/audit_transition_cutpoint_contract.py` after `prepare_transition_execution_blueprint.py` and before `audit_transition_action_anchor_contract.py`, `audit_transition_sensory_continuity_contract.py`, transition preview, audition, storyboard, Resolve apply, final QA, maturity, unattended first-draft, or V14 baseline claims.
...
After repair, rerun transition execution blueprint, cutpoint contract, action-anchor contract, sensory-continuity contract, microstructure, breathing-room, preview packet, audition packet, storyboard, unattended first-draft, V14 baseline, and maturity checks.
