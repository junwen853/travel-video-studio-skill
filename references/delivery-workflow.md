...
- transition choreography exists before transition execution blueprint, motif, motion-direction, preview, storyboard, or Resolve apply, proving every boundary has outgoing/bridge-or-motion/landing, BGM-hit, caption/title quiet-zone, restrained intensity metadata, and motion-direction plan fields that can be carried into Resolve candidate transitions
