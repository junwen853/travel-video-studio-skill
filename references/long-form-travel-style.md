...
- `shot_transition_boundary_contract_audit.json` proves each adjacent visual boundary maps to the correct from/to transition row with BGM-hit, title-safe, BGM-only, and motion-evidence checks
