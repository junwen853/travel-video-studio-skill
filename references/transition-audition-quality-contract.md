...
If a clip is missing, too short, unreadable, outside the package, contains audio, or lacks ready motion execution, rebuild the audition packet after repairing the transition execution blueprint, transition preview packet, and bridge visual evidence.
