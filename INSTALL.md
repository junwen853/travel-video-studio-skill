...
test -f ~/.codex/skills/travel-video-studio/scripts/audit_bgm_musicality_contract.py
...
test -f ~/.codex/skills/travel-video-studio/scripts/prepare_title_typography_repair_plan.py
...
test -f ~/.codex/skills/travel-video-studio/scripts/audit_transition_source_coverage_contract.py
test -f ~/.codex/skills/travel-video-studio/scripts/audit_transition_effect_recipe_contract.py
test -f ~/.codex/skills/travel-video-studio/scripts/audit_rendered_transition_proof_contract.py
...
test -f ~/.codex/skills/travel-video-studio/references/rendered-transition-proof-contract.md
test -f ~/.codex/skills/travel-video-studio/references/transition-source-coverage-contract.md
