    ...
    return {
        ...
        "selectionRubric": {
            "pass": [
                ...
                "human audition result explicitly says approved/pass and explains why the track fits opening/body/transition/ending",
                "decision explicitly marks isProceduralGenerated=false and isPlaceholderTone=false",
                "music identity is a real licensed/local music track, not a generated test bed, sine tone, hum, buzz, or drone placeholder",
            ...
            "reject": [
                ...
                "procedural sine pads, tone beds, hums, buzzes, drones without musical structure, or files named like test/sine/tone/placeholder",
                "no audition notes, no music identity type, or no opening/body/transition/ending fit explanation",
        ...
        "nextActions": [
            ...
            "Fill decision fields with selectedAssetUrl, licenseUrl, localPathAfterDownload, musicIdentityType, auditionResult, audition notes, non-procedural/non-tone flags, attribution, and approval evidence.",
