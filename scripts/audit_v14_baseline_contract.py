...
def build_report(package_dir: Path, skill_dir: Path) -> dict[str, Any]:
    ...
    add_check(
        ...
        and int(bridge_sequence_blueprint_summary.get("rowsWithSourceDiversity") or 0) == bridge_sequence_blueprint_rows
    ...
    add_check(
        ...
        and int(bridge_sequence_application_summary.get("actualUniqueSourceTotal") or 0) >= int(bridge_sequence_application_summary.get("minimumUniqueSourceTotal") or 0)
    ...
    for transition in transition_candidates:
        ...
        if (action_anchor.get("outgoingAnchor") or {}).get("ready") is True:
            outgoing_action_anchor_count += 1
    ...
    add_check(
        ...
        and int(transition_execution_blueprint_summary.get("rowsWithActionAnchorReady") or 0) == transition_execution_blueprint_rows
        and int(transition_execution_blueprint_summary.get("rowsWithOutgoingActionAnchor") or 0) == transition_execution_blueprint_rows
        ...
        and action_anchor_count == transition_execution_blueprint_rows
        ...
        and annotated_in >= transition_execution_blueprint_rows,
        {
            ...
            "actionAnchorCount": action_anchor_count,
    ...
    transition_motion_accent_summary = get_summary(transition_motion_accent)
    add_check(
        checks,
        "Transition motion accent contract proves V14 whip, rotation, push, zoom, and speed-ramp accents are rare, motivated, and readable",
        transition_motion_accent.get("status") == "passed"
        and int(transition_motion_accent_summary.get("transitionRowCount") or 0) >= 1
        and int(transition_motion_accent_summary.get("motionAccentRowCount") or 0) <= int(transition_motion_accent_summary.get("maxMotionAccentAllowed") or 999)
        and int(transition_motion_accent_summary.get("blockedMotionAccentRowCount") or 0) == 0
        and int(transition_motion_accent_summary.get("motionAccentRunMax") or 0) <= 1
        and int(transition_motion_accent_summary.get("highIntensityMotionCount") or 0) == 0
        and int(transition_motion_accent_summary.get("rotationTooStrongCount") or 0) == 0
        ...
        and int(transition_motion_accent_summary.get("titleOrCaptionRiskMotionCount") or 0) == 0
        and int(transition_motion_accent_summary.get("missingAnchorMotionCount") or 0) == 0
        and int(transition_motion_accent_summary.get("missingSensoryMotionCount") or 0) == 0
        and int(transition_motion_accent_summary.get("blockedCheckCount") or 0) == 0
        and int(transition_motion_accent_summary.get("blockerCount") or 0) == 0
    ...
    transition_action_anchor_summary = get_summary(transition_action_anchor)
    action_anchor_rows = int(transition_action_anchor_summary.get("transitionRowCount") or 0)
    important_action_anchor_rows = int(transition_action_anchor_summary.get("importantBoundaryCount") or 0)
    motion_action_anchor_rows = int(transition_action_anchor_summary.get("motionAnchorRowCount") or 0)
    add_check(
        checks,
        "Transition action-anchor contract proves V14 transitions leave from readable action, bridge or match through a motivated connector, and land on a stable shot",
        transition_action_anchor.get("status") == "passed"
        and action_anchor_rows >= 1
        and int(transition_action_anchor_summary.get("readyActionAnchorRowCount") or 0) == action_anchor_rows
        and int(transition_action_anchor_summary.get("blockedActionAnchorRowCount") or 0) == 0
        and int(transition_action_anchor_summary.get("rowsWithOutgoingActionAnchor") or 0) >= action_anchor_rows
        and int(transition_action_anchor_summary.get("rowsWithBridgeOrMatchActionAnchor") or 0) >= action_anchor_rows
        and int(transition_action_anchor_summary.get("rowsWithLandingActionAnchor") or 0) >= action_anchor_rows
        and (
            motion_action_anchor_rows == 0
            or int(transition_action_anchor_summary.get("rowsWithDirectionalMotionAnchor") or 0) >= motion_action_anchor_rows
        )
        and (
            important_action_anchor_rows == 0
            or int(transition_action_anchor_summary.get("importantRowsResolved") or 0) >= important_action_anchor_rows
        )
        and int(transition_action_anchor_summary.get("rowsWithCutpointReady") or 0) >= action_anchor_rows
        and int(transition_action_anchor_summary.get("blockedCheckCount") or 0) == 0
        and not transition_action_anchor.get("blockers"),
        {
    ...
    add_check(
        checks,
        "Transition storyboard contract proves important V14 transitions have viewer purpose, outgoing/bridge/landing proof, nonblank preview frames, and playable muted audition MP4s",
        ...
        and (
            int(transition_storyboard_summary.get("importantBoundaryCount") or 0) == 0
            or int(transition_audition_summary.get("readyAuditionRowCount") or 0) >= int(transition_storyboard_summary.get("importantBoundaryCount") or 0)
        )
        and (
            int(transition_storyboard_summary.get("importantBoundaryCount") or 0) == 0
        ...
        and (
            int(transition_storyboard_summary.get("importantBoundaryCount") or 0) == 0
            or int(transition_audition_summary.get("rowsWithActionAnchor") or 0) >= int(transition_storyboard_summary.get("importantBoundaryCount") or 0)
        )
        and (
            int(transition_storyboard_summary.get("importantBoundaryCount") or 0) == 0
            or int(transition_audition_summary.get("rowsWithOutgoingActionAnchor") or 0) >= int(transition_storyboard_summary.get("importantBoundaryCount") or 0)
        )
        and (
            int(transition_storyboard_summary.get("importantBoundaryCount") or 0) == 0
            or int(transition_audition_summary.get("rowsWithBridgeOrMatchActionAnchor") or 0) >= int(transition_storyboard_summary.get("importantBoundaryCount") or 0)
        )
        and (
            int(transition_storyboard_summary.get("importantBoundaryCount") or 0) == 0
            or int(transition_audition_summary.get("rowsWithLandingActionAnchor") or 0) >= int(transition_storyboard_summary.get("importantBoundaryCount") or 0)
        )
        and (
            int(transition_storyboard_summary.get("importantBoundaryCount") or 0) == 0
        ...
        and (
            int(transition_storyboard_summary.get("importantBoundaryCount") or 0) == 0
            or int(transition_audition_quality_summary.get("rowsWithActionAnchor") or 0) >= int(transition_storyboard_summary.get("importantBoundaryCount") or 0)
        )
        and (
            int(transition_storyboard_summary.get("importantBoundaryCount") or 0) == 0
            or int(transition_audition_quality_summary.get("rowsWithOutgoingActionAnchor") or 0) >= int(transition_storyboard_summary.get("importantBoundaryCount") or 0)
        )
        and (
            int(transition_storyboard_summary.get("importantBoundaryCount") or 0) == 0
            or int(transition_audition_quality_summary.get("rowsWithBridgeOrMatchActionAnchor") or 0) >= int(transition_storyboard_summary.get("importantBoundaryCount") or 0)
        )
        and (
            int(transition_storyboard_summary.get("importantBoundaryCount") or 0) == 0
            or int(transition_audition_quality_summary.get("rowsWithLandingActionAnchor") or 0) >= int(transition_storyboard_summary.get("importantBoundaryCount") or 0)
        )
        and (
            int(transition_storyboard_summary.get("importantBoundaryCount") or 0) == 0
        ...
        and int(transition_audition_quality_summary.get("noAudioClipCount") or 0) >= int(transition_audition_quality_summary.get("auditionClipCount") or 0)
        and transition_watch_reel.get("status") in {"ready_with_transition_watch_reel", "ready_no_important_transitions"}
        and int(transition_watch_reel_summary.get("blockedReelRowCount") or 0) == 0
        and (
            int(transition_storyboard_summary.get("importantBoundaryCount") or 0) == 0
            or int(transition_watch_reel_summary.get("readyReelRowCount") or 0) >= int(transition_storyboard_summary.get("importantBoundaryCount") or 0)
        )
        and (
            int(transition_storyboard_summary.get("importantBoundaryCount") or 0) == 0
            or transition_watch_reel_summary.get("reelBuilt") is True
        )
        and int(transition_watch_reel_summary.get("packageLocalClipCount") or 0) >= int(transition_watch_reel_summary.get("clipCount") or 0)
        and int(transition_watch_reel_summary.get("mutedClipCount") or 0) >= int(transition_watch_reel_summary.get("clipCount") or 0)
        and transition_watch_reel_review.get("status") in {"passed", "passed_no_important_transitions"}
        and int(transition_watch_reel_review_summary.get("blockedReviewRowCount") or 0) == 0
        and int(transition_watch_reel_review_summary.get("blockedCheckCount") or 0) == 0
        and (
            int(transition_storyboard_summary.get("importantBoundaryCount") or 0) == 0
            or int(transition_watch_reel_review_summary.get("passedReviewRowCount") or 0) >= int(transition_watch_reel_review_summary.get("reelRowCount") or 0)
        )
        ...
        and not transition_watch_reel.get("blockers")
        and not transition_watch_reel_review.get("blockers")
        ...
        and not transition_storyboard.get("blockers"),
        {
            ...
            "transitionAuditionPacketSummary": transition_audition_summary,
            ...
            "transitionWatchReelStatus": transition_watch_reel.get("status"),
    ...
    add_check(
        checks,
        "Transition viewer orientation contract proves V14 route, title, chapter, and ending transitions keep the audience oriented",
        transition_viewer_orientation.get("status") == "passed"
        and int(transition_viewer_orientation_summary.get("transitionRowCount") or 0) >= 3
        and int(transition_viewer_orientation_summary.get("importantBoundaryCount") or 0) >= 1
        ...
        and int(transition_viewer_orientation_summary.get("routeCueImportantCount") or 0) == int(transition_viewer_orientation_summary.get("importantBoundaryCount") or 0)
        and int(transition_viewer_orientation_summary.get("stableLandingImportantCount") or 0) == int(transition_viewer_orientation_summary.get("importantBoundaryCount") or 0)
        and int(transition_viewer_orientation_summary.get("narrativeReadyImportantCount") or 0) == int(transition_viewer_orientation_summary.get("importantBoundaryCount") or 0)
        and int(transition_viewer_orientation_summary.get("blockedCheckCount") or 0) == 0
        and int(transition_viewer_orientation_summary.get("blockerCount") or 0) == 0
    ...
    add_check(
        ...
        and int(bridge_sequence_blueprint_summary.get("rowsWithSourceDiversity") or 0) == int(bridge_sequence_blueprint_summary.get("sequenceRowCount") or 0)
        and int(bridge_sequence_blueprint_summary.get("sourceDiversityIssueRowCount") or 0) == 0
        and int(bridge_sequence_blueprint_summary.get("adjacentRepeatedSourceRowCount") or 0) == 0
        and int(bridge_sequence_blueprint_summary.get("actualUniqueSourceTotal") or 0) >= int(bridge_sequence_blueprint_summary.get("minimumUniqueSourceTotal") or 0)
        ...
        and first_draft_satisfaction.get("status") == "passed"
        ...
        and int(transition_sequence_satisfaction_summary.get("requiredSequenceReportCount") or 0) >= 30
        and int(transition_sequence_satisfaction_summary.get("transitionSequenceRowCount") or 0) == 0
        and int(transition_sequence_satisfaction_summary.get("p0TransitionSequenceRowCount") or 0) == 0
        and int(transition_sequence_satisfaction_summary.get("metricIssueCount") or 0) == 0
        ...
        and int(rhythm_summary.get("primaryVisualShotCount") or 0) >= 40,
        {
            ...
            "transitionSequenceSatisfactionSummary": transition_sequence_satisfaction_summary,
        },
    )
    ...
    add_check(
        checks,
        "Final viewer friction contract proves V14 handoff has no open title, BGM, caption, source, story, transition, reference-fit, route-texture, or watchdown repair rows",
        final_viewer_friction.get("status") == "passed"
        and int(final_viewer_friction_summary.get("evidenceReportCount") or 0) >= 20
        and int(final_viewer_friction_summary.get("passedEvidenceReportCount") or 0) == int(final_viewer_friction_summary.get("evidenceReportCount") or 0)
        and int(final_viewer_friction_summary.get("viewerFrictionRowCount") or 0) == 0
        and int(final_viewer_friction_summary.get("p0ViewerFrictionRowCount") or 0) == 0
        and int(final_viewer_friction_summary.get("p1ViewerFrictionRowCount") or 0) == 0,
        {
            "finalViewerFrictionStatus": final_viewer_friction.get("status"),
            "finalViewerFrictionSummary": final_viewer_friction_summary,
        },
    ...
    add_check(
        checks,
        "First draft satisfaction contract proves V14 handoff closes source, opening, BGM, caption, story, rhythm, transition, reference, route, and watchdown rows before final QA",
        first_draft_satisfaction.get("status") == "passed"
        and int(first_draft_satisfaction_summary.get("requiredReportCount") or 0) >= 40
        and int(first_draft_satisfaction_summary.get("passedReportCount") or 0) == int(first_draft_satisfaction_summary.get("requiredReportCount") or 0)
        and int(first_draft_satisfaction_summary.get("satisfactionRowCount") or 0) == 0
        and int(first_draft_satisfaction_summary.get("p0SatisfactionRowCount") or 0) == 0
        and int(first_draft_satisfaction_summary.get("p1SatisfactionRowCount") or 0) == 0,
        {
            "firstDraftSatisfactionStatus": first_draft_satisfaction.get("status"),
            "firstDraftSatisfactionSummary": first_draft_satisfaction_summary,
        },
    ...
    add_check(
        checks,
        "Transition sequence satisfaction contract proves V14 handoff has no open viewer-sequence, watch-reel, bridge, landing, motion-restraint, Resolve, rendered-proof, or reference-fit rows",
        transition_sequence_satisfaction.get("status") == "passed"
        and int(transition_sequence_satisfaction_summary.get("requiredSequenceReportCount") or 0) >= 30
        and int(transition_sequence_satisfaction_summary.get("passedSequenceReportCount") or 0) == int(transition_sequence_satisfaction_summary.get("requiredSequenceReportCount") or 0)
        and int(transition_sequence_satisfaction_summary.get("transitionSequenceRowCount") or 0) == 0
        and int(transition_sequence_satisfaction_summary.get("p0TransitionSequenceRowCount") or 0) == 0
        and int(transition_sequence_satisfaction_summary.get("p1TransitionSequenceRowCount") or 0) == 0
        and int(transition_sequence_satisfaction_summary.get("metricIssueCount") or 0) == 0,
        {
            "transitionSequenceSatisfactionStatus": transition_sequence_satisfaction.get("status"),
            "transitionSequenceSatisfactionSummary": transition_sequence_satisfaction_summary,
