...
REPORT_SPECS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "priority": "P0",
        "phase": "transition_flow",
        "viewerSymptom": "Transitions may be technically valid in pieces but still feel unpleasant, random, too flashy, audio-leaky, or unlanded as a viewer sequence.",
        ...
        "acceptanceEvidence": "Transition sequence satisfaction passes with zero sequence rows, zero P0 rows, zero metric issues, and closed watch-reel/bridge/landing/Resolve/rendered proof.",
        "forbiddenWorkaround": "Do not hand off a cut whose transition subreports pass while the ordered viewer sequence still has audio leakage, repeated high-intensity effects, missing bridge breath, or unproven landings.",
    },
    {
